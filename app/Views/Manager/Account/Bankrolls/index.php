...
<div class="modal fade" id="createBabkrollsModal" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-md" role="document">
    <div class="modal-content">
      ...
      <?= form_open("manager/account/bankrolls/store"); ?>
        <div class="modal-body">

          <?= $this->include('Manager/Account/Bankrolls/form'); ?>
    ...
    <div class="modal-content">
      ...
      <div class="card">
        <div class="card-body py-2">
          ...
          <?= form_open("manager/account/bankrolls/reset", '', $hidden); ?>
...
<div class="modal fade" id="editBankrollModal" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-md" role="document">
    <div class="modal-content">
      ...
      <?= form_open("manager/account/bankrolls/update", '', $hidden); ?>
        <div class="modal-body">
    ...
    <div class="modal-content">
      ...
      <div class="card">
        <div class="card-body py-2">
          ...
          <?= form_open("manager/account/bankrolls/delete", '', $hidden); ?>
