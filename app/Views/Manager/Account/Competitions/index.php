...
<div class="modal fade" id="transferCompetitionModal" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-sm" role="document">
    <div class="modal-content">
      ...
      <?= form_open("manager/account/competitions/update"); ?>
        <div class="modal-body">

          <?= $this->include('Manager/Account/Competitions/form_transfer'); ?>
...
<div class="modal fade" id="editCompetitionModal" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-sm" role="document">
    <div class="modal-content">
      ...
      <?= form_open("manager/account/competitions/update", '', $hidden); ?>
        <div class="modal-body">
    ...
    <div class="modal-content">
      ...
      <div class="card">
        <div class="card-body py-2">
          ...
          <?= form_open("manager/account/competitions/delete", '', $hidden); ?>
