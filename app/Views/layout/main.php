              ...
              <ul class="navbar-nav flex-row align-items-center ms-auto">
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li>
                      <a class="dropdown-item" href="<?= site_url('manager/account/profile'); ?>">
                    ...
                    <li>
                      <a class="dropdown-item" href="<?= site_url('manager/account/billing-and-plans'); ?>">
          ...
          <div class="content-wrapper">
            <div class="container-xxl flex-grow-1 container-p-y">            
              <div class="row">
                ...
                <!-- This section will render the specific contents of the view that extends this layout -->
